...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""} >
      <Head>
        <title>Katie Krupczak Portfolio</title>
      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className="min-h-screen">
          ...
          <nav className='py-10 mb-12 flex justify-between dark:text-white'>
            <h1 className='text-xl font-burtons'>Katie Krupczak</h1>
          ...
          <div className='text-center p-10'>
            ...
            <p className='text-md py-5 leading-8 text-gray-800 dark:text-gray-200 md:text-xl mx-w-lg mx-auto'>
              Freelance providing services for programming and design content needs. Join me down below and let's get cracking!
            </p>
          </div>
        ...
        <section>
          <div>
            ...
            <p className='text-md py-2 leading-8 text-gray-800 dark:text-gray-200'>
              ...
              , consulted for 
              <span className="text-teal-500"> startups</span>, and collaborated with talented people
              to create digital projects for both business and consumer use
            </p>
          ...
          <div className='lg:flex gap-10'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-gray-100 flex-1'>
              ...
              <p className='py-2'>
                Creating elegant designs suited for your needs using core design theory
              </p>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-gray-100 flex-1'>
              <Image src={consulting} width={100} height={100} className="relative mx-auto"/>
              <h3 className='text-lg font-medium pt-8 pb-2'>Beautiful Designs</h3>
              <p className='py-2'>
                Creating elegant designs suited for your needs using core design theory
              </p>
        ...
        <section>
          ...
          <div className='flex flex-col gap-10 py-10 md:flex-row md:flex-wrap'>
            <div className='basis-1/3 flex-1 xl:basis-1/3.5'>
